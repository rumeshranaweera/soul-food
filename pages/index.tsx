      ...
      <div>
        ...
        <div className="reviews my-2">
          ...
          <div className="overflow-hidden w-screen max-w-4xl flex relative justify-center mx-auto h-96">
            ...
            <button
              className="text-3xl absolute top-0 bottom-0 left-1 my-auto"
              onClick={() => setIndex(index + 1)}
            >
              <p className="bg-primaryColor bg-opacity-60 dark:text-backGroundDark rounded-full px-2">
                {" "}
                {"<"}{" "}
              </p>
            </button>
            <button
              className="text-3xl absolute top-0 bottom-0 right-1 my-auto "
              onClick={() => setIndex(index - 1)}
            >
              <p className="bg-primaryColor bg-opacity-60 dark:text-backGroundDark rounded-full px-2">
                {" "}
